        ...
        <Container fluid="true" className="footer">
            <Row className="m-0 pt-3">
                <Col className="contact" md={6} sm={12} lg={6}>
                    ...
                    <a href="sekulhassan.cm">Notice</a><br/>
                    <a href="sekulhassan.cm">Registration</a><br/>
                    <a href="sekulhassan.cm">JU CSE</a><br/>
                ...
                <Col className="contact" md={6} sm={12} lg={6}>
                    ...
                    <div className="iconDiv">
                        ...
                        <a className="contactLink mx-1" href="sekulhassan.cm"><FontAwesomeIcon icon={faTwitter}/> </a>
                        <a className="contactLink mx-1" href="sekulhassan.cm"><FontAwesomeIcon icon={faInstagram}/> </a>
                        <a className="contactLink mx-1" href="sekulhassan.cm"><FontAwesomeIcon icon={faLinkedin}/> </a>
                    </div>
                </Col>
            </Row>
